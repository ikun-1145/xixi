...
(function initSiteI18n(global) {
  ...
  const rows = [
    ...
    ["加载中...", "Loading...", "読み込み中..."],
    ["加载中…", "Loading…", "読み込み中…"],
    ["页面加载失败，请刷新重试", "Page failed to load. Refresh and try again.", "ページを読み込めませんでした。再読み込みしてください。"],
    ...
    ["Sunland AI · Beta 暂不支持图片上传", "Sunland AI · Beta does not support image uploads yet", "Sunland AI · Beta は画像アップロードにまだ対応していません"],
    ...
    ["模型加载中", "Loading models", "モデルを読み込み中"],
    ["正在加载模型…", "Loading models…", "モデルを読み込み中…"],
    ["模型列表加载失败，点击重试", "Could not load models. Tap to retry.", "モデルの読み込みに失敗しました。タップして再試行してください。"],
    ...
    ["每次只能上传 1 张图片", "You can upload one image at a time", "一度にアップロードできる画像は1枚です"],
    ["仅支持 JPG、PNG、GIF 和 WEBP 图片", "Only JPG, PNG, GIF, and WEBP images are supported", "JPG、PNG、GIF、WEBP画像のみ対応しています"],
    ["请描述并分析这张图片。", "Describe and analyze this image.", "この画像について説明・分析してください。"],
    ["[本轮包含图片；原图未写入对话历史]", "[Image included in this turn; the original was not stored in chat history]", "[このターンには画像が含まれています。原画像はチャット履歴に保存されていません]"],
    ...
    ["正在检查账号状态...", "Checking account status...", "アカウントの状態を確認しています..."],
    ["暂时无法确认账号状态，请稍后再试", "We couldn't verify the account status. Please try again later.", "アカウントの状態を確認できません。後でもう一度お試しください。"],
    ["账号已被封禁", "This account has been banned", "このアカウントは利用停止されています"],
    ["封禁原因：", "Ban reason: ", "利用停止の理由："],
    ["警告：当前账号已被封禁，无法继续使用。", "Warning: This account has been banned and cannot continue to use the service.", "警告：このアカウントは利用停止されているため、サービスを続けて利用できません。"],
    ["暂未提供封禁原因。", "No ban reason was provided.", "利用停止の理由は提供されていません。"],
    ["如需申诉，请发送邮件至", "To appeal, please email", "異議申し立ては次のメールアドレスまでご連絡ください："],
    ["如有疑问，请联系管理员。", "If you have questions, contact the administrator.", "ご不明な点は管理者にお問い合わせください。"],
    ...
    ["公告 - Sunland AI · Beta", "Announcements - Sunland AI · Beta", "お知らせ - Sunland AI · Beta"],
    ["返回设置", "Back to settings", "設定に戻る"],
    ["这里仅展示当前有效的服务公告。", "Only currently active service announcements are shown here.", "現在有効なサービスのお知らせのみを表示します。"],
    ["正在加载公告…", "Loading announcements…", "お知らせを読み込んでいます…"],
    ["当前没有有效公告。", "There are no active announcements.", "現在有効なお知らせはありません。"],
    ["公告暂时无法加载，请稍后重试。", "Announcements are temporarily unavailable. Please try again later.", "お知らせを読み込めません。しばらくしてからもう一度お試しください。"],
    ["重试", "Retry", "再試行"],
    ["发布时间：", "Published: ", "公開日時："],
    ...
    ["Android 与 iOS 下载", "Android & iOS downloads", "Android・iOS版ダウンロード"],
    ["Android 7.0+；iOS IPA 适用于已注册测试设备或自行签名安装", "Android 7.0+; the iOS IPA requires a registered test device or personal re-signing", "Android 7.0以降。iOS IPAは登録済みテスト端末または再署名が必要です"],
